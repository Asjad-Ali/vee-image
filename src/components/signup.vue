    ...
    <v-main class="mb-10">
      <v-container>
        ...
        <v-row class="d-flex align-center justify-center">
          <div><h4 class="logStyle" ><b>Vee</b>Image</h4></div>
        </v-row>
        <v-row class="d-flex align-center justify-center mt-0 pt-0">
          ...
          <v-col cols="12" lg="2" md="2" sm="2" xs="10">
            <div class="d-flex align-center justify-center pb-10 pt-3"><h4>OR</h4></div>
          </v-col>
          <v-col cols="6" lg="3" md="3" sm="3" xs="10" class="d-flex align-start justify-start">
